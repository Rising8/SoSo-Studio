                ...
                <nav class="navbar navbar-expand-md" data-bs-theme="dark">
                    <ul class="navbar-nav flex-row gap-3">
                        ...
                        <li class="nav-item dropdown">
                            <a href="<?php echo esc_url( home_url( '/commission' ) ); ?>"
                            ...
                            <ul class="dropdown-menu rounded-3" aria-labelledby="customDropdown">
                                ...
                                <li><a class="dropdown-item rounded-3" href="<?php echo esc_url( home_url( '/custom' ) ); ?>">Design Your Rug</a></li>
                                <li><a class="dropdown-item rounded-3" href="<?php echo esc_url( home_url( '/commission-form' ) ); ?>">Request a Custom Rug</a></li>
                            </ul>
                        </li>
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="<?php echo esc_url( home_url( '/commission' ) ); ?>"
                               class="nav-link dropdown-toggle"
                               id="customDropdownMobile"
                               role="button"
                               data-bs-toggle="dropdown"
                               aria-expanded="false">
                                Commissions
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="customDropdownMobile">
                                <li><a class="dropdown-item" href="<?php echo esc_url( home_url( '/commission' ) ); ?>">How It Works</a></li>
