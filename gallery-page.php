...
<div class="gallery-wrapper p-0">
    ...
    <!-- Gallery Page - Testimonials Section -->
    <div class="gallery-content-4 p-5">
        <div class="gallery-testimonials p-5 text-center rounded-3">
            <h2 class="text-body-emphasis fs-3 fs-md-2 fs-lg-1 pb-3">Why They Chose Us</h2>
                <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <!-- Testimonial 1 -->
                        <div class="carousel-item active">
                            <p class="gallery-testimonials-p col-lg-8 mx-auto text-muted fs-6 fs-md-5 fs-lg-4">
